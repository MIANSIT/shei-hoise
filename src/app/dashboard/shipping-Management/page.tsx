...
export default function AdminShippingPage() {
  ...
  if (!storeSlug) {
    return (
      <div className="min-h-[60vh] flex items-center justify-center p-4">
        <div className="bg-card rounded-2xl border border-red-100 dark:border-red-900/40 shadow-xl p-10 max-w-sm w-full text-center">
    ...
    <div className="min-h-screen bg-slate-50/50 dark:bg-slate-900/50">
      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 sm:mb-10">
          ...
          <div className="flex items-center gap-2 bg-card border border-border rounded-xl px-4 py-2.5 shadow-sm self-start sm:self-auto">
