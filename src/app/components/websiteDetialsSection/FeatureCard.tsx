...
const FeatureCard: React.FC<FeatureCardProps> = ({ feature }) => {
  return (
    <div className="bg-card rounded-xl border border-border p-7 shadow-sm hover:shadow-lg transition-all duration-300 group hover:border-primary/50">
      <div className="w-14 h-14 bg-linear-to-br from-primary to-primary/80 rounded-xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300 shadow-md">
