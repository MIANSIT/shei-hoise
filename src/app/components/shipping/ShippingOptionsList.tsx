  ...
  return (
    <div className="p-4 sm:p-6 space-y-3">
      ...
      {options.length === 0 && isEditing && (
        <div
          onClick={onAdd}
          className="text-center py-12 sm:py-16 border-2 border-dashed border-border rounded-xl cursor-pointer hover:border-blue-300 dark:hover:border-blue-600 hover:bg-blue-50/30 dark:hover:bg-blue-900/10 transition-all duration-200 group"
        >
      ...
      {isEditing && (
        <button
          onClick={onAdd}
          type="button"
          className="w-full flex items-center justify-center gap-2 py-3 rounded-xl border-2 border-dashed border-border text-muted-foreground hover:border-blue-300 dark:hover:border-blue-600 hover:text-blue-500 dark:hover:text-blue-400 hover:bg-blue-50/40 dark:hover:bg-blue-900/10 transition-all duration-200 text-sm font-medium group"
        >
