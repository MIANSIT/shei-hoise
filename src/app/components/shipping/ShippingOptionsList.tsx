// File: app/components/shipping/ShippingOptionsList.tsx
"use client";
    ...
    <div>
      ...
      <div className="p-2">
        <div className="space-y-4 sm:space-y-6">
          ...
          {options.length === 0 && isEditing && (
            <div className="text-center py-16 sm:py-24 border-2 border-dashed border-gray-300/50 rounded-3xl bg-linear-to-br from-gray-50/30 to-gray-100/10 backdrop-blur-sm">
              ...
              <button
                onClick={handleAdd}
                className="inline-flex items-center justify-center space-x-3 bg-linear-to-r from-blue-500 to-indigo-600 text-white px-8 py-4 rounded-2xl hover:from-blue-600 hover:to-indigo-700 transition-all duration-300 shadow-lg shadow-blue-500/25 font-semibold text-[15px] backdrop-blur-sm"
              >
