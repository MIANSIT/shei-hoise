...
const PUBLIC_SAFE_COLUMNS =
  "id, store_id, currency, tax_rate, free_shipping_threshold, min_order_amount, processing_time_days, return_policy_days, terms_and_conditions, privacy_policy, shipping_fees, facebook_pixel_id, created_at, updated_at";
