...
/** `orderedIds` is the full banner list in its new drag-and-drop order — each id's index becomes its new sort_order. */
export async function reorderPromoBanners(orderedIds: string[]): Promise<{ success: boolean; error?: string }> {
